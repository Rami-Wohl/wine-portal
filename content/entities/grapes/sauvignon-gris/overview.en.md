...
## Identity and origins — different skins, the same family
...
### Colchagua provides an example without blending partners

In Chile's [[region.colchagua|Colchagua]], Casa Silva's 1912 Vines Sauvignon Gris supplies a documented varietal-wine example. The producer connects it to its historical Angostura vineyard and specifies stainless-steel [[concept.elevage|maturation]]. It challenges the assumption that Sauvignon Gris is only a French blending grape or necessarily an oak-matured wine. [@source.casa-silva-sauvignon-gris]

The producer describes citrus and ripe fruit alongside volume and freshness. These are notes for this wine, not a universal Chilean tasting profile. A first-hand example demonstrates a possibility, not exclusivity, superior quality or one national style.
:::
...
## Wine styles and sensory profile — Sauvignon with greater breadth

Sauvignon Gris can produce powerful, full-bodied whites. Compared with Sauvignon Blanc, Plantgrape describes lower acidity and greater sugar accumulation potential. In the glass this may mean more breadth and weight, but harvest timing and fermentation determine the actual alcohol, acidity and any residual sugar. [@source.plantgrape-sauvignon-gris]

Citrus, flowers, ripe stone fruit or tropical fruit are useful aromatic associations. The CIVB description and Chilean producer example do not present exactly the same profile. That difference is not an error: place and treatment allow different aspects to emerge. An aromatic wine is not automatically sweet either. [@source.civb-sauvignon-gris] [@source.casa-silva-sauvignon-gris]
:::
...
## Climate, site and soils — freshness involves a harvest decision

High sugar accumulation potential makes harvest timing important. Waiting longer can give more weight, but a maker must also consider acidity, aroma development and fruit health. A warm plot does not automatically deliver a better result than a cooler one. Appropriate ripeness depends on the intended style.

Soil and water influence rooting, growth and ripening pace. This page therefore does not attach Sauvignon Gris to one required soil or a single soil-driven aroma. Its relationship with Sauvignon Blanc helps initial orientation, but cannot replace local observation of Sauvignon Gris. [@source.plantgrape-sauvignon-gris]
:::

:::section{#groeicyclus depth="intermediate" source_refs="source.plantgrape-sauvignon-gris"}
## Vine and growing cycle — less fruit, considerable sugar potential

Plantgrape describes Sauvignon Gris as less productive than Sauvignon Blanc, with small bunches and berries. Budburst is placed around ten days after Chasselas and maturity two to two and a half weeks after that reference variety. These are comparative data, not a fixed timetable for both France and Chile. [@source.plantgrape-sauvignon-gris; Phenology]

From flowering and fruit set through ripening, bunches, skin colour and composition change. Pink-grey colouring in the photograph is a visible feature of this image, not proof of a sugar level or an ideal picking point. Growers assess ripeness through several observations rather than berry colour alone.
:::
...
[[concept.lees-ageing|Lees ageing]], maturation with the yeast sediment left after fermentation, can form part of a more textured cellar style. The extent of [[concept.oxidation|oxidation]], changes caused by oxygen, must be managed deliberately. Appropriate wine handling tells us more than an assumption that grey Sauvignon automatically needs longer oak ageing or skin contact.
:::
...
## Synonyms, clones and relationships — distinguish mutation, naming and selection

The close relationship with Sauvignon Blanc matters, but a colour mutation does not arise by combining two parents as a cross does. [[concept.clonal-selection|Clonal selection]] can subsequently take place within Sauvignon Gris itself. Plantgrape records clone 917 and conservatories preserving broader variation. A selected clone need not represent every existing vine. [@source.plantgrape-sauvignon-gris]

The historical name Fié Gris is associated with the grape, whereas Plantgrape lists no officially recognised EU synonym in its variety sheet. Historical usage and official registration should not be presented as identical. The similarly spelled Souvignier Gris likewise supplies no genetic conclusion. [@source.civb-sauvignon-gris] [@source.plantgrape-sauvignon-gris; Synonymy]

In [[concept.ampelography|ampelography]], the description of grapevines, Plantgrape describes features resembling Sauvignon Blanc except for ripe skin colour. A photograph shows that colour but cannot independently rule out misidentification or variation.
:::

:::section{#etiket depth="foundation" source_refs="source.civb-sauvignon-gris source.casa-silva-sauvignon-gris"}
## Labels and recognition — “Sauvignon” can tell too little

A French origin name does not automatically reveal whether Sauvignon Gris was used or in what proportion. Nor is “Sauvignon” without further explanation certain evidence of the grey form. Producer information helps establish composition.

On an explicitly named Sauvignon Gris wine, the variety is clearer but the style is not fully explained. An unoaked wine can be broad, and a fresh aroma does not establish acidity. Variety, place and cellar choices together are more useful than a single recognition word.
:::

:::section{#heden depth="intermediate" source_refs="source.plantgrape-sauvignon-gris source.casa-silva-sauvignon-gris"}
## Contemporary developments — another option in white wine
