...
### Blending, coupage and legal language

“Blending” is a broad term in everyday wine language. The OIV, the international wine organisation, defines it more specifically as mixing different wines. [@source.oiv-blending-code] European law gives **coupage** its own legal description: mixing wines or musts — grape juice that has not yet fermented — that differ in origin, grape variety, harvest year or category. [@source.eu-wine-coupage-regulation-2019]
...
### Small trial blends, repeated choices

Winemakers can first make small trial blends, adjust the ratios and taste again. A modest addition may alter the entire impression, so more of a component is not automatically better. The process is iterative: compare, combine, return and choose again. [@source.civb-bordeaux-blending]

The final percentages are the outcome of that work, not the starting point of an immutable recipe.
:::
...
Blending allows room for judgement, but it is not a licence to do anything. Under the OIV code, it must not be used to conceal microbiological or chemical alteration, and the resulting wine must comply with the applicable composition and analysis requirements. [@source.oiv-blending-code]

European rules also place conditions on which categories, origins and colours may be mixed. The constituents must themselves be compliant, and the final wine must meet the rules of the category or protected name it carries. [@source.eu-wine-coupage-regulation-2019]
:::

:::section{#percentages-lezen depth="foundation" source_refs="source.civb-bordeaux-blending"}
## Percentages — useful, but never the whole story

A statement such as 70% Merlot and 30% [[grape.cabernet-sauvignon|Cabernet Sauvignon]] tells you the proportion of varieties in the final wine. That helps you recognise its composition. It does not reveal which parcels supplied the wine, how rigorously it was selected, how each lot was made or when everything was brought together.
...
Blending is the art of choosing: separate lots retain their possibilities until the winemaker decides which combination speaks most convincingly as one wine.
:::

:::caveat{#geen-kwaliteitslabel depth="advanced" variant="simplification" source_refs="source.oiv-blending-code"}
“Blend” names a process, not a quality level. A blend can be simple or extraordinarily ambitious, while a single-variety wine may be assembled just as carefully from many lots.
:::
