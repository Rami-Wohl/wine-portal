...
### Assemblage, coupage en versnijding

In dagelijks wijngebruik is “assemblage” een ruim begrip. De OIV, de internationale wijnorganisatie, definieert blending specifieker als het mengen van verschillende wijnen. [@source.oiv-blending-code] Europese regelgeving gebruikt voor **coupage**, in het Nederlands **versnijding**, een eigen juridische omschrijving: het mengen van wijnen of most — het nog niet vergiste druivensap — die verschillen in herkomst, druivenras, oogstjaar of categorie. [@source.eu-wine-coupage-regulation-2019]
...
### Kleine proefblends, herhaalde keuzes

Wijnmakers kunnen eerst kleine proefmengsels maken, de verhoudingen verschuiven en opnieuw proeven. Een bescheiden toevoeging kan de hele indruk van een blend veranderen; meer van een component is daarom niet automatisch beter. Het proces is iteratief: vergelijken, combineren, terugkeren en opnieuw kiezen. [@source.civb-bordeaux-blending]

De uiteindelijke percentages zijn de uitkomst van dat werk, niet het beginpunt van een onveranderlijk recept.
:::

:::detail{#regels-en-grenzen parent="proeven-en-samenstellen" depth="advanced" source_refs="source.oiv-blending-code source.eu-wine-coupage-regulation-2019"}
### Vrijheid binnen grenzen

Assemblage biedt speelruimte, maar geen vrijbrief. Volgens de OIV mag blending niet worden gebruikt om een microbiologische of chemische aantasting te verhullen, en moet de uiteindelijke wijn aan de geldende samenstellings- en analyse-eisen voldoen. [@source.oiv-blending-code]

Europese regels stellen daarnaast voorwaarden aan welke categorieën, herkomsten en kleuren mogen worden gemengd. De onderdelen moeten zelf rechtmatig zijn en de uiteindelijke wijn moet voldoen aan de regels van de categorie of beschermde naam die hij draagt. [@source.eu-wine-coupage-regulation-2019]
:::

:::section{#percentages-lezen depth="foundation" source_refs="source.civb-bordeaux-blending"}
## Percentages — nuttig, maar nooit het hele verhaal

Een vermelding als 70% merlot en 30% [[grape.cabernet-sauvignon|cabernet sauvignon]] vertelt hoe de druivenrassen zich in de uiteindelijke wijn tot elkaar verhouden. Dat helpt om de compositie te herkennen. Het vertelt nog niet van welke percelen de wijn kwam, hoe streng werd geselecteerd, hoe iedere partij werd gemaakt of wanneer alles werd samengebracht.
...
Assemblage is de kunst van kiezen: afzonderlijke partijen bewaren hun mogelijkheden totdat de wijnmaker beslist welke combinatie als één wijn het overtuigendst spreekt.
:::

:::caveat{#geen-kwaliteitslabel depth="advanced" variant="simplification" source_refs="source.oiv-blending-code"}
“Assemblage” is een proces, geen kwaliteitslabel. Een blend kan eenvoudig of uiterst ambitieus zijn, en een wijn van één druivenras kan net zo zorgvuldig uit vele partijen zijn samengesteld.
:::
