# Contentbrief — Élevage

Datum: 2026-09-16. Outline en bronnenplan goedgekeurd voor authoring.

## Voorkennis en paginabelofte

Geen kelderkennis vereist; gist, most, fenolen en andere vakwoorden worden bij eerste gebruik uitgelegd. Hoe de jonge wijn vóór botteling wordt begeleid via vatkeuze, tijd, zuurstof, lies, assemblage en voorbereiding, zonder opvoeding tot hout terug te brengen.
...
| --- | --- | --- | --- |
| `jonge-wijn-begeleiden` — Opvoeding vóór botteling | basis | Opvoeding versus flesrijping en hout is de identiteit. | Wat betekent élevage? Is een tank ook opvoeding? Is langer beter? |
| `vatkeuze` — Tank, vat en eikenhout | basis + verdieping | Materiaal herkennen WSET 2; maat, ouderdom en toast verklaren WSET 3. | Wat verandert vatkeuze? Waarom oud hout niet hetzelfde is als nieuw? Wat zegt een percentage nieuw hout? |
| `werk-in-de-kelder` — Zuurstof, lies en kelderwerk | basis + verdieping + gevorderd | Begeleiding herkennen is basis; mechanisme verdieping en zuurstofmodel gevorderd. | Waarom bijvullen en overhevelen? Wat is lies? Is zuurstof altijd goed of altijd slecht? |
| `richting-botteling` — Assemblage en botteling | basis + verdieping | Het einddoel van de kelderfase en verschillende gereedschappen verklaren scope. | Wat worden stijl en stabiliteit? Is filtering universeel? Wat gaat naar flesontwikkeling? |
